...
<div class="bg-dark text-white py-4">
    <div class="container d-flex justify-content-between align-items-center">
        <h1 class="fw-bold mb-0 text-start">Create New Product</h1>
                ...
                <div class="row g-4">
                    <div class="col-md-8">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="form-control bg-light border-0 py-2" value="{{ old('name') }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="5" class="form-control bg-light border-0 py-2">{{ old('description') }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="mb-4">
                            ...
                            <input type="number" name="price" id="price" step="0.01" class="form-control bg-light border-0 py-2" value="{{ old('price') }}" required>
                            @error('price') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="mb-4">
                            <label for="stock" class="form-label small fw-bold text-muted text-uppercase">Stock Quantity</label>
                            <input type="number" name="stock" id="stock" class="form-control bg-light border-0 py-2" value="{{ old('stock') }}" required>
                    ...
                    <div class="col-12 pt-4 border-top">
                        <button type="submit" class="btn btn-warning px-5 py-3 fw-bold rounded-pill shadow-sm">Save Product <i class="bi bi-check2-circle ms-1"></i></button>
                    </div>
                </div>
            </form>
        </div>
