...
<div class="bg-dark text-white py-4">
    <div class="container d-flex justify-content-between align-items-center">
        <h1 class="fw-bold mb-0 text-start">Edit Product: {{ $product->name }}</h1>
            ...
            <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 pt-4 border-top">
                        <button type="submit" class="btn btn-warning px-5 py-3 fw-bold rounded-pill shadow-sm">Update Product <i class="bi bi-check2-circle ms-1"></i></button>
                    </div>
                </div>
            </form>
        </div>
